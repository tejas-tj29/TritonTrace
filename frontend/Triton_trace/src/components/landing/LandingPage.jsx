...
export const LandingPage = () => {
  ...
  return (
    <div className="w-full flex flex-col font-sans antialiased overflow-x-hidden">
      ...
      <section id="workflow" className="w-full bg-slate-50 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      {/* 4. Data Source Strip */}
      <section id="sources" className="w-full border-t border-slate-200 bg-white py-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-wrap justify-center md:justify-end items-center gap-2 sm:gap-3 text-[11px] font-mono font-medium">
              <span className="rounded border border-slate-200 bg-slate-50 px-3 py-1.5 text-slate-700">Copernicus Sentinel-1 C-SAR</span>
              <span className="rounded border border-slate-200 bg-slate-50 px-3 py-1.5 text-slate-700">CMEMS Physical Ocean Analysis</span>
              <span className="rounded border border-slate-200 bg-slate-50 px-3 py-1.5 text-slate-700">Marine Cadastre Historical AIS</span>
              <span className="rounded border border-slate-200 bg-slate-50 px-3 py-1.5 text-slate-700">NOAA GFS Surface Winds</span>
            </div>
          </div>
        </div>
      </section>
